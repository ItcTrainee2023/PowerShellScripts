...
-Name $subnetName -AddressPrefix $subnetAddressPrefix
...
-Name $publicIPAddress -ResourceGroupName $resourceGroup `
-Location $location -AllocationMethod Static

$networkInterfaceName="app-interface"

$VirtualNetwork=Get-AzVirtualNetwork `
-Name $networkName -ResourceGroupName $resourceGroup

$subnet=Get-AzVirtualNetworkSubnetConfig `
-VirtualNetwork $VirtualNetwork -Name $subnetName
...
$networkInterface | Set-AzNetworkInterfaceIpConfig `
...
-Name "Allow-RDP" -Access Allow -Protocol Tcp `
-Direction Inbound -Priority 120 `
-SourceAddressPrefix Internet -SourcePortRange * `
-DestinationAddressPrefix 10.0.0.0/24 `
-DestinationPortRange 3389

$nsgRule2=New-AzNetworkSecurityRuleConfig `
-Name "Allow-HTTP" -Access Allow -Protocol Tcp `
-Direction Inbound -Priority 130 `
-SourceAddressPrefix Internet -SourcePortRange * `
-DestinationAddressPrefix 10.0.0.0/24 `
...
$availabilitySet=New-AzAvailabilitySet -Location $location `
-ResourceGroupName $resourceGroup `
...
$vmConfig=New-AzVMConfig -Name $vmName `
-VMSize $VMSize -AvailabilitySetId $availabilitySet.Id
Set-AzVMOperatingSystem -VM $vmConfig `
-ComputerName $vmName -Credential $Credential -Windows
